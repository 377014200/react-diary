...
// --downlevelIteration                                    boolean                           false                         在for..of中提供对迭代器的全面支持。当以ES5或ES3为目标时，会发生扩散和破坏。
...
// >>>
// <<<
// --moduleResolution	                                       string	(module === "AMD" | "System" | "ES6" ?    决定如何处理模块。或者是"Node"对于Node.js/io.js，或者是"Classic"（默认）。查看模块解析了解详情。
//                                                                            "Classic" : "Node")
// >>>
...
// --rootDir	                                                   string	                           (common)	            仅用来控制输出的目录结构--outDir。
