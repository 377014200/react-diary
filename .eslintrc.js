...
module.exports = {
    ...
    'rules' : {
        ...
        // react  https://github.com/yannickcr/eslint-plugin-react // react Rules
        "react/jsx-no-undef" : 1,//在jsx中禁止未声明的变量
        "react/jsx-no-duplicate-props" : 1,//防止在jsx中重复的props
        "react/jsx-no-target-blank" : 0,//防止在jsx中重复的props
        "react/jsx-wrap-multilines" : ["error", {  // 防止多行JSX周围缺少括号(可修复)
        ...
        "react/jsx-curly-spacing": [2, {  // 在JSX属性和表达式中强制或禁止花括号内的空格(可修复)
            "children": true,
            "when": "always",
            "spacing": {
        ...
        //防止在jsx中重复的props
        "react/jsx-closing-bracket-location" : 1,// 验证JSX中的右括号位置(可修复)
        "react/jsx-boolean-value" : 1,//当属性值等于true的时候，省略该属性的赋值
        "react/jsx-first-prop-new-line": "error",  //如果JSX标记占用多行并且有多个属性，那么应该始终将第一个属性放在新行上。这是默认值。
        ...
        "no-extra-parens": ["error", "all", { ignoreJSX: "multi-line" }], //禁止非必要的括号
        ...
        "newline-after-var": 2, //变量声明后是否需要空一行 此规则在ESLint v4.0.0 中已弃用
        "one-var": 2, //连续声明
